...
def test_preprocessing():
    ...
    try:
        ...
        pass
    conf = load_test_conf()
    pyeo_1.raster_manipulation.atmospheric_correction("test_data/L1", "test_outputs/L2",
                                                    conf['sen2cor']['path'])
...
def test_merging():
    ...
    try:
        ...
        pass
    pyeo_1.raster_manipulation.preprocess_sen2_images("test_data/L2/", "test_outputs/", "test_data/L1/", buffer_size=5)
...
def test_stacking():
    ...
    try:
        ...
        pass
    pyeo_1.raster_manipulation.stack_old_and_new_images(r"test_data/S2B_MSIL2A_20180103T172709_N0206_R012_T13QFB_20180103T192359.tif",
...
def test_mask_closure():
    ...
    pyeo_1.raster_manipulation.buffer_mask_in_place(out_mask_path, 3)


def test_get_l1():
    os.chdir(os.path.dirname(os.path.abspath(__file__)))
    output = pyeo_1.filesystem_utilities.get_l1_safe_file(
...
def test_get_l2():
    os.chdir(os.path.dirname(os.path.abspath(__file__)))
    output = pyeo_1.filesystem_utilities.get_l2_safe_file(
        "test_data/S2A_MSIL2A_20180329T171921_N0206_R012_T13QFB_20180329T221746.tif",
        "test_data/L2"
    )
...
def test_get_tile():
    os.chdir(os.path.dirname(os.path.abspath(__file__)))
    assert pyeo_1.filesystem_utilities.get_sen_2_image_tile("test_data/T13QFB_20180103T172709_20180329T171921.tif") == "T13QFB"
    assert pyeo_1.filesystem_utilities.get_sen_2_image_tile("test_data/S2A_MSIL2A_20180329T171921_N0206_R012_T13QFB_20180329T221746.tif") == "T13QFB"