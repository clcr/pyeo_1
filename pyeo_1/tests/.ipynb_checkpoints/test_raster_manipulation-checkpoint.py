...
def test_composite_images_with_mask():
    ...
    pyeo_1.raster_manipulation.composite_images_with_mask(test_data, out_file, generate_date_image=True)
...
def test_composite_across_projections():
    ...
    pyeo_1.raster_manipulation.reproject_image(test_data[0], r"test_outputs/reprojected/0.tif", projection)
    pyeo_1.raster_manipulation.reproject_image(test_data[1], r"test_outputs/reprojected/1.tif", projection)
    pyeo_1.raster_manipulation.reproject_image(pyeo_1.filesystem_utilities.get_mask_path(test_data[0]), r"test_outputs/reprojected/0.msk", projection)
    pyeo_1.raster_manipulation.reproject_image(pyeo_1.filesystem_utilities.get_mask_path(test_data[1]), r"test_outputs/reprojected/1.msk", projection)

    out_file = r"test_outputs/composite_test.tif"
    pyeo_1.raster_manipulation.composite_images_with_mask([
...
def test_reprojection():
    ...
    pyeo_1.raster_manipulation.reproject_image(image, out_file, new_projection, do_post_resample=False)
...
def test_buffered_composite():
    ...
    pyeo_1.raster_manipulation.composite_images_with_mask(test_data, out_file)
...
def test_composite_off_by_one():
    ...
    pyeo_1.raster_manipulation.composite_directory("test_data/off_by_one", "test_outputs/off_by_one_error", generate_date_images=True)
...
def test_raster_sum():
    ...
    pyeo_1.raster_manipulation.raster_sum(inRstList=test_image_list, outFn=out_path)
...
def test_mask_buffering():
    ...
    [pyeo_1.raster_manipulation.buffer_mask_in_place(mask, 2) for mask in test_masks]
...
def test_ml_masking():
    ...
    pyeo_1.raster_manipulation.create_mask_from_model(
...
def test_mask_combination():
    ...
    try:
        ...
        pass
    pyeo_1.raster_manipulation.combine_masks(masks, "test_outputs/union_or_combination.tif",
                                           geometry_func="union", combination_func="or")
    pyeo_1.raster_manipulation.combine_masks(masks, "test_outputs/intersection_and_combination.tif",
                                           geometry_func="intersect", combination_func="and")
    pyeo_1.raster_manipulation.combine_masks(masks, "test_outputs/intersection_or_combination.tif",
                                           geometry_func="intersect", combination_func="or")
    pyeo_1.raster_manipulation.combine_masks(masks, "test_outputs/union_and_combination.tif",
...
def test_mask_from_confidence_layer():
    ...
    try:
        ...
        pass
    pyeo_1.raster_manipulation.create_mask_from_confidence_layer(
...
def test_fmask():
    ...
    try:
        ...
        pass
    pyeo_1.raster_manipulation.apply_fmask(
...
def test_fmask_cloud_mask():
    ...
    try:
        ...
        pass
    pyeo_1.raster_manipulation.create_mask_from_fmask(
        "test_data/S2A_MSIL1C_20170922T025541_N0205_R032_T48MXU_20191021T161210.SAFE",
...
def test_combination_mask():
    ...
    try:
        ...
        pass
    pyeo_1.raster_manipulation.create_mask_from_sen2cor_and_fmask(
        "test_data/S2A_MSIL1C_20170922T025541_N0205_R032_T48MXU_20191021T161210.SAFE",
        "test_data/S2A_MSIL2A_20170922T025541_N0205_R032_T48MXU_20170922T031450.SAFE",
...
def test_mask_joining():
    ...
    try:
        ...
        pass
    pyeo_1.raster_manipulation.combine_masks(["test_data/masks/fmask_cloud_and_shadow.tif", "test_data/masks/confidence_mask.tif"],
...
def test_s2_band_stacking():
    ...
    pyeo_1.raster_manipulation.stack_sentinel_2_bands(test_safe_file, default_out)
    some_bands_10m = "test_outputs/band_stacking/with_reproj.tif"
    pyeo_1.raster_manipulation.stack_sentinel_2_bands(test_safe_file, some_bands_10m, out_resolution=20)
    weird_bands = "test_outputs/band_stacking/weird_bands.tif"
    pyeo_1.raster_manipulation.stack_sentinel_2_bands(test_safe_file, weird_bands,
...
def test_band_maths():
    ...
    pyeo_1.raster_manipulation.apply_band_function(test_file,
                                                 pyeo_1.raster_manipulation.ndvi_function,
                                                 [2, 3],
                                                 test_outputs,
...
def test_averaging():
    ...
    pyeo_1.raster_manipulation.average_images(test_files, test_output)
...
def test_clip_geojson():
    ...
    pyeo_1.raster_manipulation.clip_raster(test_image, test_json, out_path)
...
def test_remove_raster_band():
    ...
    pyeo_1.raster_manipulation.strip_bands(test_file, out_path, [2])
...
def test_create_new_image_from_polygon():
    ...
    pyeo_1.raster_manipulation.create_new_image_from_polygon(polygon, out_path, x_res, y_res, bands,
