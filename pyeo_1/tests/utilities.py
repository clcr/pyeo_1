...
To set up:
    - Download test_data.zip from https://s3.eu-central-1.amazonaws.com/pyeo_1data/test_data.zip (~15gb)
    - Unzip in pyeo_1/pyeo_1/tests (so that gives you pyeo_1/pyeo_1/tests/test_data)
