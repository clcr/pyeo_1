...
def test_classification():
    ...
    try:
        ...
        pass
    pyeo_1.classification.classify_image("test_data/composite_T36MZE_20190509T073621_20190519T073621_clipped.tif",
...
def test_raster_reclass_binary():
    ...
    a = pyeo_1.classification.raster_reclass_binary(test_image_name, test_value, outFn=out_filename)
