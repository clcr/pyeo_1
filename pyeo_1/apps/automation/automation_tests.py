...
data_directory = '/data/clcr/shared/IMPRESS/Ivan/pyeo_1/pyeo_1/pyeo_1/apps/automation'
sen2cor_path = '/home/i/ir81/Sen2Cor-02.09.00-Linux64'
conda_environment_path = '/home/i/ir81/miniconda3/envs/pyeo_env'
code_directory = '/data/clcr/shared/IMPRESS/Ivan/pyeo_1/pyeo_1/pyeo_1/apps/automation'
config_directory = '/data/clcr/shared/IMPRESS/Ivan/pyeo_1/pyeo_1/pyeo_1/apps/automation'
...
# log_path = '/data/clcr/shared/IMPRESS/Ivan/pyeo_1/pyeo_1/pyeo_1/apps/automation'
# models_path = '/data/clcr/shared/IMPRESS/Ivan/pyeo_1/pyeo_1/pyeo_1/apps/automation'
# pbs_outputs_path = '/data/clcr/shared/IMPRESS/Ivan/pyeo_1/pyeo_1/pyeo_1/apps/automation'
# pbs_errors_path = '/data/clcr/shared/IMPRESS/Ivan/pyeo_1/pyeo_1/pyeo_1/apps/automation'
...
for tile in tile_list:
    ...
    print(f'automation_test.py: Checking if tile {tile} is already being processed and, if so, delete process to avoid possible conflicts')
    ...
    shell_command_string = f"./automate_launch.sh '{python_launch_string}' '{qsub_launch_string}'"
...
for i in range(monitoring_cycles):
    ...
    print(f'automation_test.py: Checking which tiles are still being processed after {i * monitoring_period_seconds} seconds')
    ...
    if (not df.empty):
        for tile in tile_list:
            ...
            for index, p in current_tile_processes_df.iterrows():
                ...
                if (p['Status'] in ['Q', 'R']):
                    job_id = p['JobID'].split('.')[0]
                    print(f'Tile {tile} still running pid: {job_id}, status; {p["Status"]} ')
    else:
        break
