...
import argparse
from pyeo_1.validation import produce_stratified_validation_points
from pyeo_1.filesystem_utilities import init_log

if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        "Generates a shapefile containing n stratified random points"
    ...
    parser.add_argument(
        "--random_seed", help="If given, override the random seed. For testing."
    )
