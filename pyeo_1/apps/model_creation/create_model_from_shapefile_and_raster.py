...
if __name__=="__main__":
    ...
    training_shape_path = conf["pyeo_1"]["shapefile"]
    training_raster_path = conf["pyeo_1"]["raster"]
    model_out_path = conf["pyeo_1"]["model"]
    class_field = conf["pyeo_1"]["class_field"]
    log_path = conf["pyeo_1"]["log_path"]
