from pyeo_1.classification import create_model_from_signatures
import argparse

if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        "Creates a pixel classification model from a signature file produces from "
        "extract_signatues."
    )
    parser.add_argument(
        "sig_file",
        help="Path to the .csv file containing the signatures. The first column should"
