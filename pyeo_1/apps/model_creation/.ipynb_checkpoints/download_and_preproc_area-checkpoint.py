...
def main(aoi_path, start_date, end_date, l1_dir, l2_dir, merge_dir, conf_path,
    ...
    if download_l2_data:
        ...
        pyeo_1.queries_and_downloads.download_s2_data(products, l1_dir, l2_dir, user=conf["sent_2"]["user"],
    ...
    pyeo_1.raster_manipulation.preprocess_sen2_images(l2_dir, merge_dir, l1_dir, cloud_threshold=0,
