...
if __name__ == "__main__":
    ...
    log = pyeo_1.filesystem_utilities.init_log("model.log")
    ...
    pyeo_1.classification.create_rf_model_for_region(args.region_path, args.out_path, args.class_attribute_field, args.band_names, args.gridsearch, args.kfold)
