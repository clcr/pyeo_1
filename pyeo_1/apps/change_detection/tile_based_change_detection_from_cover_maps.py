...
def rolling_detection(
    ...
    try:
        ...
        if arg_start_date == "LATEST":
            ...
            after_timestamp = pyeo_1.filesystem_utilities.get_change_detection_dates(
        ...
        if build_composite or do_all:
            ...
            (
                ...
                sizes,
            ) = pyeo_1.raster_manipulation.find_small_safe_dirs(
            ...
            if len(files_for_cloud_masking) == 0:
                ...
                pyeo_1.raster_manipulation.apply_processing_baseline_offset_correction_to_tiff_file_directory(
            ...
            if len(masked_file_paths) > 0:
                ...
                for root, dirs, files in os.walk(composite_dir):
                    ...
                    for this_tiff in all_tiffs:
                        pyeo_1.raster_manipulation.compress_tiff(
        ...
        if do_all or do_classify:
            ...
            pyeo_1.classification.classify_directory(
                composite_dir,
                model_path,
        ...
        if do_all or do_change:
            ...
            if sieve > 0:
                ...
                sieved_paths = pyeo_1.raster_manipulation.sieve_directory(
            ...
            class_image_paths.sort(
                key=lambda x: pyeo_1.filesystem_utilities.get_image_acquisition_time(x)
            )
            ...
            for index, image in enumerate(class_image_paths):
                ...
                if do_dev:
                    ...
                    pyeo_1.raster_manipulation.__change_from_class_maps(
                    ...
                    pyeo_1.raster_manipulation.change_from_class_maps(
                        latest_class_composite_path,
                        image,
                        change_raster,
                        change_from=from_classes,
            ...
            if not do_dev:
                ...
                pyeo_1.raster_manipulation.combine_date_maps(
