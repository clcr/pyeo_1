    ...
    try:
        ...
        if build_composite:
            ...
            if do_download or download_l2_data or do_all:
                ...
                if download_l2_data:
                    ...
                    composite_products = (
                        pyeo_1.queries_and_downloads.filter_non_matching_s2_data(
                            composite_products_all
                        )
                    )
                    log.info(
                ...
                if (do_download or do_all) and not download_l2_data:
                    ...
                    composite_products = pyeo_1.queries_and_downloads.filter_to_l1_data(
                        composite_products
                    )
                    log.info(
                ...
                pyeo_1.raster_manipulation.preprocess_sen2_images(
                    composite_l2_image_dir,
            ...
            if do_download or download_l2_data or do_all:
                ...
                products = pyeo_1.queries_and_downloads.check_for_s2_data_by_date(
                    aoi_path,
                    start_date,
                    end_date,
                    conf,
                ...
                if download_l2_data:
                    ...
                    products = pyeo_1.queries_and_downloads.filter_non_matching_s2_data(
                        products
                    )
                ...
                for image in images:
                    ...
                    try:
                        latest_composite_path = (
                            pyeo_1.filesystem_utilities.get_preceding_image_path(
                    ...
                    new_stack_path = (
                        pyeo_1.raster_manipulation.stack_image_with_composite(
                            new_image_path,
                            latest_composite_path,
                            stacked_image_dir,
        ...
        if do_classify or do_all:
            ...
            if do_mask or do_all:
                ...
                pyeo_1.raster_manipulation.apply_mask_to_dir(
                ...
                for masked_stacked_image_file in masked_stacked_image_files:
                    ...
                    if build_prob_image:
                        ...
                        new_prob_image = None
                    pyeo_1.classification.classify_image(
