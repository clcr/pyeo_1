...
def rolling_detection(config_path,
    ...
    pyeo_1.filesystem_utilities.create_file_structure(project_root)
    log = pyeo_1.filesystem_utilities.init_log(log_path)
    ...
    try:
        ...
        if build_composite:
            ...
            if do_download or download_l2_data or do_all:
                ...
                composite_products_all = pyeo_1.queries_and_downloads.check_for_s2_data_by_date(aoi_path,
                ...
                if download_l2_data:
                    ...
                    composite_products = pyeo_1.queries_and_downloads.filter_non_matching_s2_data(composite_products_all)
                    ...
                    if len(composite_products) > 0:
                        ...
                        pyeo_1.queries_and_downloads.download_s2_data(composite_products, 
                ...
                if (do_download or do_all) and not download_l2_data:
                    ...
                    composite_products = pyeo_1.queries_and_downloads.filter_to_l1_data(composite_products)
                ...
                pyeo_1.raster_manipulation.preprocess_sen2_images(composite_l2_image_dir, 
            ...
            pyeo_1.raster_manipulation.clever_composite_directory(composite_merged_dir, 
                                                                composite_dir, 
                                                                chunks=30,
            ...
            if do_download or download_l2_data or do_all:
                ...
                products = pyeo_1.queries_and_downloads.check_for_s2_data_by_date(aoi_path,
                                                                                start_date, 
                                                                                end_date, 
                                                                                conf,
                                                                                cloud_cover=cloud_cover,
                ...
                if download_l2_data:  
                    log.info("Restricting query results to include only matching L1C and L2A products.")
                    products = pyeo_1.queries_and_downloads.filter_non_matching_s2_data(products)
                    log.info("{} L2A products remain".format(len(products)))
                    log.info("Downloading selected products.")
                    pyeo_1.queries_and_downloads.download_s2_data(products, 
                                                                l1_image_dir, 
                                                                l2_image_dir, 
                                                                download_source,
                                                                user=sen_user, 
                    ...
                    products = pyeo_1.queries_and_downloads.filter_to_l1_data(products)
                    log.info("Downloading selected products.")
                    pyeo_1.queries_and_downloads.download_s2_data(products, 
                                                                l1_image_dir, 
                                                                l2_image_dir, 
            ...
            if do_merge or do_all:
                ...
                pyeo_1.raster_manipulation.preprocess_sen2_images(l2_image_dir, 
                                                                merged_image_dir, 
                                                                l1_image_dir,
                                                                cloud_certainty_threshold,
                                                                epsg=epsg,
            ...
            if do_stack or do_all:
                ...
                for image in images:
                    ...
                    try:
                        latest_composite_path = pyeo_1.filesystem_utilities.get_preceding_image_path(new_image_path,
                                                                                               composite_dir)
                    ...
                    new_stack_path = pyeo_1.raster_manipulation.stack_image_with_composite(new_image_path,
        ...
        if do_mosaic or do_all:
            ...
            pyeo_1.raster_manipulation.mosaic_images(stacked_image_dir, mosaic_image_dir, format="GTiff", 
        ...
        if do_classify or do_all:
            ...
            # Apply a mask of pixels to be classified to all images in the directory
                ...
                pyeo_1.raster_manipulation.apply_mask_to_dir(mask_path, 
                                                           stacked_image_dir, 
                ...
                for masked_stacked_image_file in masked_stacked_image_files:
                    ...
                    if build_prob_image:
                        ...
                        new_prob_image = None
                    pyeo_1.classification.classify_image(masked_stacked_image_file, 
                                                       model_path, 
                                                       new_class_image, 
                                                       new_prob_image,
                ...
                for stacked_image_file in stacked_image_files:
                    ...
                    if build_prob_image:
                        ...
                        new_prob_image = None
                    pyeo_1.classification.classify_image(stacked_image_file, 
                                                       model_path, 
                                                       new_class_image, 
                                                       new_prob_image,
                                                       num_chunks=num_chunks, 
        ...
        if do_update or do_all:
            ...
            new_composite_path = os.path.join(
                composite_dir, "composite_{}.tif".format(
                    pyeo_1.filesystem_utilities.get_sen_2_image_timestamp(os.path.basename(image))))
