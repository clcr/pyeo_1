...
if __name__ == "__main__":
    ...
    parser.add_argument("new_image", help="Path to the newer image to be compared")
    ...
    with TemporaryDirectory() as td:
        ...
        pyeo_1.raster_manipulation.stack_images([args.old_image, args.new_image], stacked_path, geometry_mode="intersect")
        pyeo_1.classification.classify_image(stacked_path, args.model, args.output, prob_out_path=None,
