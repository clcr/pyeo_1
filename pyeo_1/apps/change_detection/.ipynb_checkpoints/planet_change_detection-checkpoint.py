...
if __name__ == "__main__":
    ...
    api_key = pyeo_1.queries_and_downloads.load_api_key(api_key_path)

    # Download two images

    pyeo_1.queries_and_downloads.download_planet_image_on_day(aoi_path, date_1, planet_image_path, api_key)
    pyeo_1.queries_and_downloads.download_planet_image_on_day(aoi_path, date_2, planet_image_path, api_key)
